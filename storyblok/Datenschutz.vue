<template>
  <div>
    <div class="container mb-32 mt-20 pt-10">
      <p>
        Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen.
        Datenschutz hat einen besonders hohen Stellenwert für die
        Geschäftsleitung der CL Schmitz GmbH. Eine Nutzung der Internetseiten
        der CL Schmitz GmbH ist grundsätzlich ohne jede Angabe personenbezogener
      ...
      <p>
        ...
        Übereinstimmung mit den für die CL Schmitz GmbH geltenden
      ...
      <p>
        Die CL Schmitz GmbH hat als für die Verarbeitung Verantwortlicher
      ...
      <p>
        Die Datenschutzerklärung der CL Schmitz GmbH beruht auf den
      ...
      <h2>3. Cookies</h2>
      <p>
        Die Internetseiten der CL Schmitz GmbH verwenden Cookies. Cookies sind
      ...
      <p>
        Durch den Einsatz von Cookies kann die CL Schmitz GmbH den Nutzern
      ...
      <p>
        Die Internetseite der CL Schmitz GmbH erfasst mit jedem Aufruf der
      ...
      <p>
        Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die CL
        Schmitz GmbH keine Rückschlüsse auf die betroffene Person. Diese
        ...
        erhobenen Daten und Informationen werden durch die CL Schmitz GmbH daher
      ...
      <p>
        Die Internetseite der CL Schmitz GmbH enthält aufgrund von gesetzlichen
      ...
      <ul style="list-style: none">
        ...
        <li>
          ...
          <p>
            ...
            Person die Löschung von personenbezogenen Daten, die bei der CL
            Schmitz GmbH gespeichert sind, veranlassen möchte, kann sie sich
            hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der CL Schmitz GmbH wird
            veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der CL Schmitz GmbH
            öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
            gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
            verpflichtet, so trifft die CL Schmitz GmbH unter Berücksichtigung
            ...
            nicht erforderlich ist. Der Mitarbeiter der CL Schmitz GmbH wird im
        ...
        <li>
          ...
          <p>
            ...
            bei der CL Schmitz GmbH gespeichert sind, verlangen möchte, kann sie
        ...
        <li>
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der CL Schmitz GmbH
            wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die CL Schmitz GmbH verarbeitet die personenbezogenen Daten im Falle
          ...
          <p>
            Verarbeitet die CL Schmitz GmbH personenbezogene Daten, um
            ...
            steht. Widerspricht die betroffene Person gegenüber der CL Schmitz
            GmbH der Verarbeitung für Zwecke der Direktwerbung, so wird die
            Ristorante Piccobello die personenbezogenen Daten nicht mehr für
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der Ristorante
            Piccobello zu wissenschaftlichen oder historischen Forschungszwecken
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der CL Schmitz GmbH oder einen
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die CL Schmitz GmbH angemessene
      ...
      <p>
        ...
        <a
          ...
          >Externer Datenschutzbeauftragter Fürth</a
        >
        tätig ist, in Kooperation mit dem
        <a href="https://www.wbs-law.de/it-recht/datenschutzrecht/"
          >IT- und Datenschutzrecht Anwalt Christian Solmecke</a
        >
        erstellt.
      </p>
    </div>
